...
# Suppress InsecureRequestWarning — verify=False is intentional in a security scanner.
# We MUST connect to targets with misconfigured/expired TLS to assess their posture.
    ...
    def check_connectivity(self, url, ip, target=None):
        try:
            if url:
                ...
                # verify=False: intentional — scanner must assess targets with bad TLS
