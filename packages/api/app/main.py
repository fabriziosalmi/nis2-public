...
from app.routers import api_keys, assets, auth, certificates, findings, governance, health, incidents, organizations, remediation, reports, scans, schedules
...
def create_app() -> FastAPI:
    ...
    class BrandingMiddleware(BaseHTTPMiddleware):
        async def dispatch(self, request: Request, call_next):
            ...
            response.headers["X-NIS2-Platform"] = "v2.2.7"
