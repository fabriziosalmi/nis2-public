...
async def _run_scan(scan_id: str) -> dict:
    ...
    async with async_session_factory() as db:
        ...
        try:
            ...
            scan.findings_critical = report.stats.get("critical_risk_hosts", 0)
            scan.findings_high = report.stats.get("high_risk_hosts", 0)
            scan.findings_medium = report.stats.get("medium_risk_hosts", 0)
            scan.findings_low = report.stats.get("low_risk_hosts", 0)
