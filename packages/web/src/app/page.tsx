...
// lucide-react removed brand icons in v1.0.0. Inline replacement.
const Github = ({ className, "aria-hidden": ariaHidden }: { className?: string, "aria-hidden"?: boolean | "true" | "false" }) => (
  <svg
