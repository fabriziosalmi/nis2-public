...
from nis2scan.compliance import ComplianceReport
...
class TestReporterRendering(unittest.TestCase):
    ...
    @unittest.skipUnless(
        os.path.exists("templates/report_template.html"),
        "Skipped: must run from packages/scanner/ directory for template access"
    )
